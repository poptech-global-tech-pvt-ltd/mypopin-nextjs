        ...
        <Script id="gtag">
          ...
          `}
            ...
            <section className="py-24 max-w-6xl mx-auto">
                <div className={`text-[28px] ${manrope.className} font-[700] pb-2 pt-10`}>Privacy Policy</div>
                <p className={` text-[20px] pb-4 ${manrope.className} font-[500] `}>This section pertains to the Privacy Policy of POPclub owned by Popclub Vision Tech Pvt Limited. We would like to inform you that our Privacy Policy is subject to change without intimation and you shall be required to review the same regularly</p>
                <p className={` text-[20px] pb-4 ${manrope.className} font-[500] `}>
                ...
                <div className={`text-[28px] ${manrope.className} font-[700] pb-2`}>PLEASE READ THE FOLLOWING TERMS OF OUR PRIVACY POLICY PERSONAL INFORMATION COLLECTED</div>
                <p className={` text-[20px] pb-4 ${manrope.className} font-[500] `}>
                ...
                <div className={`text-[28px] ${manrope.className} font-[700] pb-2`}>COOKIES:</div>
                <p className={` text-[20px] pb-4 ${manrope.className} font-[500] `}>
                ...
                <div className={`text-[28px] ${manrope.className} font-[700] pb-2`}>USE OF INFORMATION COLLECTED:</div>
                <p className={` text-[20px] pb-4 ${manrope.className} font-[500] `}>
                ...
                <div className={` text-[20px] pb-4 ${manrope.className} font-[700] pb-2`}>How We Use the Information we collect</div>
                <p className={` text-[20px] pb-4 ${manrope.className} font-[500] `}>
