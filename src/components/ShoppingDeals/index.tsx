...
function ShoppingDeals() {
    ...
    return (
        <div className="max-w-6xl mx-auto">
            <h1 className={`px-4 lg:px-0 text-[35px] leading-9 lg:leading-0 text-center lg:text-6xl py-16 font-bold lg:mb-[150px] ${khand.className}`}>Best Shopping Deals Online</h1>
