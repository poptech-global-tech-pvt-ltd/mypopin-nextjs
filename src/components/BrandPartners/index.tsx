                ...
                <div className="max-w-6xl mx-auto my-auto text-white grid grid-cols-1 lg:grid-cols-[1fr_1fr_1fr_2.2fr]">
                    <div className='mx-auto grid grid-cols-2 lg:grid-cols-1'>
                        ...
                        <div>
                            ...
                            <div className={`${manrope.className} text-[11px] text-left lg:text-center`}>Showcase coins at key points in the customer journey to boost conversion.</div>
                        </div>
                    </div>
                    <div className='mx-auto grid grid-cols-2 lg:grid-cols-1'>
                        <Image className='mx-auto lg:w-[60%] w-[45%]' width="127" height="127" src="/in-depth-integration.svg" alt="in depth integration" />
                        <div>
                            ...
                            <div className={`${manrope.className} text-[11px] text-left lg:text-center `}>Highly activated d2c customer base in the popcoins network.</div>
                        </div>
                    </div>
                    <div className='mx-auto grid grid-cols-2 lg:grid-cols-1'>
                        <Image className='mx-auto lg:w-[60%] w-[45%]' width="127" height="127" src="/in-depth-integration.svg" alt="in depth integration" />
                        <div>
                            ...
                            <div className={`${manrope.className} text-[11px] text-left lg:text-center`}>Access actionable insights to drive further customer engagement.</div>
                        </div>
                    </div>
                    <div className='-order-1 lg:order-last'>
                        <div className={`text-[44px] lg:text-8xl ${khand.className} text-center pb-8 lg:pb-0 lg:text-end`}>Why Brands Partner With POPcoins</div>
                    </div>
                </div>
            </div>
        </>
